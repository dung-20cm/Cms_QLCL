    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 dark:border-gray-800 dark:bg-gray-900 sm:px-6">
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition duration-150 hover:bg-gray-50 active:scale-90 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 text-gray-500 transition duration-150 hover:bg-gray-50 hover:rotate-12 active:scale-90 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
